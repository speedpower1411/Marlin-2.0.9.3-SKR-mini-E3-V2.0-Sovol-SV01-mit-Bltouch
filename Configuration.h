...
#define STRING_CONFIG_H_AUTHOR "(speedpower1411, Sovol SV01)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  35.10,  35.10 }
    #define DEFAULT_Ki_LIST {   3.87,   3.87 }
    #define DEFAULT_Kd_LIST {   79.4,   79.4 }
  #else
    #define DEFAULT_Kp  35.10
